...
k_values <- seq(min_k, 90, by = 2)  # Test k_fea values from 100 to 1000 in steps of 100
...
min_k <- 118
# Initialize variables
k_values <- seq(min_k, 118, by = 2)  # Test k_fea values from 100 to 1000 in steps of 100
max_balanced_acc <- -Inf             # To store the maximum balanced accuracy
best_k_fea <- NULL                   # To store the best k_fea
df_data_train <- as.data.frame(as.matrix(sparse_data_train))
