...
selected_features_gbm_100 <- importance[importance_gbm$scaled_importance > 0, "variable"]
length(selected_features100)
```
...
predictions_gbm90 <- (h2o.predict(gbm_model_selected90, test_h2o))
predictions_gbm90 <- as.data.frame(predictions_gbm90)
predictions_gbm90 <- as.numeric(predictions_gbm90$p1)  

predicted_classes_gbm90 <- ifelse(predictions_gbm90 > max_balanced_accuracy_gbm90$Threshold, 1, 0) #Using optimal threshold

conf_matrix_gbm90 <- table(Predicted =  predicted_classes_gbm90 , Actual = y_true)
print("Confusion Matrix Gradient Boosting Method:")
print(conf_matrix_gbm90)


balanced_accuracy_gbm90 <- calculate_balanced_accuracy(conf_matrix_gbm90)
cat("The Balanced Accuracy of Gradient Boosting Method on the test set is:", balanced_accuracy_gbm90, "\n")
```
